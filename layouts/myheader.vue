<template>
    <div class="header-container">
        ...
        <el-dropdown v-if="name != ''" @command="loginMenu">
         ...
         <!-- 登录弹出层 -->
    <el-dialog v-if=dialogUserFormVisible :visible.sync="dialogUserFormVisible" style="text-align: left;" top="100px" :append-to-body="true"  width="550px" @close="closeDialog()">
      <div class="container"> 
        <!-- 手机登录 #start -->
        <div class="operate-view" v-if="dialogAtrr.showLoginType === 'phone'" >
          <div class="wrapper" style="width: 100%" center>
